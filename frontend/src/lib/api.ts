...
export const api = {
  ...
  getPatientProfile: (id: number = getActivePatientId()) =>
  ...
  turn: (text: string, patientId: number = getActivePatientId()) =>
  ...
  getLocations: (since = "24h", patientId: number = getActivePatientId()) =>
  ...
  uploadLabRecord: (
    file: File,
    patientId: number = getActivePatientId(),
  ...
  listLabRecords: (patientId: number = getActivePatientId()) =>
